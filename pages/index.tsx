    ...
    <div className='p-5'>
      ...
      <div className='max-w-[350px] mx-auto flex-col items-center xl:mt-14 2xl:mt-[12vh]'>
        ...
        <div className='flex justify-center'>
          {!loading ? (
            <button
              className='focus:outline-2 outline-[var(--text)] active:brightness-95 scale-105 mt-10 xl:mb-2 sm:mb-0 mb-2 bg-blue rounded-xl text-white px-6 py-3 select-none active:scale-100 transition'
            ...
            <button className='focus:outline-2 outline-[var(--text)] scale-105 mt-10 xl:mb-2 sm:mb-0 mb-2 bg-gradient-to-r from-sky-300 to-blue background-animate rounded-xl px-14 py-3 select-none cursor-no-drop transition'>
