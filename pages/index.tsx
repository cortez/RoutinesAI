    ...
    <div className="bg-white flexmax-w-full mx-auto flex-col items-center justify-center">
      ...
      <main className="flex flex-1 w-full flex-col items-center justify-center text-center px-4">
        ...
        {!loading && (
          <>
            <button
              className="xl:mb-2 sm:mb-0 mb-2 mt-2 bg-black rounded-lg text-white font-medium px-6 py-3 w-xl focus:outline-black select-none hover:bg-neutral-700 active:scale-95 transition"
        ...
        {loading && (
          <button
            className="transition xl:mb-2 sm:mb-0 mb-0 loading-button bg-gradient-to-r from-sky-400 to-blue-500 background-animate font-medium rounded-lg px-14 py-3 w-xl focus:outline-black select-none cursor-no-drop"
          >
