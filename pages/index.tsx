      ...
      <div className="bg-white flexmax-w-full mx-auto flex-col items-center justify-center">
        ...
        <main className="flex flex-1 w-full flex-col items-center justify-center text-center px-4">
          ...
          <div className="mt-4 sm:w-1/2 lg:w-1/3 xl:w-1/4 w-full">
            ...
            {loading && (
              <button
                className="sm:mb-3 -mb-1 loading-button bg-gradient-to-r from-lime-400 to-teal-400 background-animate font-medium rounded-xl text-black font-medium px-20 py-5 w-xl focus:outline-black select-none sm-mb:0 cursor-no-drop"
              >
